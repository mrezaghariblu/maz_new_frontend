  ...
  template: `
    ...
    @if (loading()) {
      ...
      <div class="profile-header">
        ...
        @if (auth.isSuperuser()) {
              <button class="maz-btn maz-btn--sm" [class.maz-btn--danger]="user()!.canLogin" [class.maz-btn--ghost]="!user()!.canLogin" (click)="toggleCanLogin()">
...
export class UserDetailComponent implements OnInit {
  ...
  toggleCanLogin() {
    ...
    const msg = newVal ? 'آیا می‌خواهید دسترسی ورود این کاربر را فعال کنید؟' : 'آیا می‌خواهید دسترسی ورود این کاربر را غیرفعال کنید؟';
